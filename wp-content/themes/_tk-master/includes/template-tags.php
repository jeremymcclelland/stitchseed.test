...
function _tk_content_nav( $nav_id ) {
	...
	<nav role="navigation" id="<?php echo esc_attr( $nav_id ); ?>" class="<?php echo $nav_class; ?>">
		...
		<?php if ( is_single() ) : // navigation links for single posts ?>
			...
			<?php previous_post_link( '<li class="nav-previous previous">%link</li>', '<span class="meta-nav">' . _x( '<i class="fa fa-chevron-left"></i>', 'Previous post link', '_tk' ) . '</span> Previous' ); ?>
			<?php next_post_link( '<li class="nav-next next">%link</li>', 'Next <span class="meta-nav">' . _x( '<i class="fa fa-chevron-right"></i>', 'Next post link', '_tk' ) . '</span>' ); ?>
